    ...
    #Numpad1::
    {
        SendInput("git remote -v")
        Return
    }

    #Numpad2::
    {
        SendInput("git remote add origin_tutorial https://github.com/fgp555/tutorial.git")
        Return
    }

    #Numpad3::
    {
        SendInput("git add . && git commit --amend --no-edit && git push origin_tutorial main --force")
        Return
    }
